...
{
  template <typename T>
  const T & SRMINERvA::Reco(const SRMINERvA::ID& id)
  {
  ...
  template const SRTrack & SRMINERvA::Reco<SRTrack>(const SRMINERvA::ID& id);
  template const SRShower & SRMINERvA::Reco<SRShower>(const SRMINERvA::ID& id);
}
